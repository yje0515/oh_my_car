	...
	<div class="join">
		...
		<form role="form" method="post" action="/user/join" id="joinForm"
			...
			<div class="checked">
				...
				<input type="hidden" id="emailChecked" name="emailChecked" value="notYet">
				<input type="hidden" class="ruleChecked" id="userIdRuleChecked" name="userIdRuleChecked" value="notYet">
				<input type="hidden" class="ruleChecked" id="userNameRuleChecked" name="userNameRuleChecked" value="notYet">
				<input type="hidden" class="ruleChecked" id="passwordRuleChecked" name="passwordRuleChecked" value="notYet">
				<input type="hidden" class="ruleChecked" id="emailRuleChecked" name="emailRuleChecked" value="notYet">
			</div>
	</div>
	<script>
		...
		$('#password').focusout(function(){
				...
				if(!passwordRule.test($("#password").val())){
					$("#passwordRule").show();
					$("#passwordRuleChecked").val("notYet");
					return false;
				}else{
					$("#passwordRule").hide();
					$("#passwordRuleChecked").val("ok");
				}
			})
			$('#email').focusout(function(){
				...
				if(!emailRule.test($("#email").val())){
					$("#emailRule").show();
					$("#emailRuleChecked").val("notYet");
					return false;
				}else{
					$("#emailRule").hide();
					$("#emailRuleChecked").val("ok");
				}
