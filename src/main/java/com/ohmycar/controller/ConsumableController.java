...
public class ConsumableController {
	...
	private static final String REDIRECT_MYPAGE = "redirect:/carInfo/carlist";
	 ...
	 */
	@GetMapping("/read")
	public String read(@RequestParam("carId") String carId, Model model) throws Exception {
	...
	public String create(@RequestParam("carId") String carId, ConsumableVO vo, String accDist,
		...
		String token = code == null ? null : calc.getAccessToken(code);
